...
(1, 'Where do hurricanes usually form?', 'A. In the centre of large continents', 'B. Over warm tropical oceans near the equator', 'C. In the open Arctic sea', 'D. In freshwater lakes', 2),
(2, 'Which of these is a renewable source of energy?', 'A. Coal', 'B. Wind', 'C. Oil', 'D. Natural gas', 2),
(2, 'What country has the most time zones?', 'A. France', 'B. Russia', 'C. United States', 'D. Philippines', 1),
...
(2, 'Which term describes people moving from the countryside into the cities?', 'A. Globalisation', 'B. Deforestation', 'C. Urbanisation', 'D. Desertification', 3),
(3, 'What is the largest desert in the world?', 'A. Sahara Desert', 'B. Antarctic Desert', 'C. Gobi Desert', 'D. Arabian Desert', 2),
...
(3, 'Which of these is mainly caused by waves repeatedly breaking against a cliff?', 'A. Sand dune formation', 'B. River meanders', 'C. Coastal erosion', 'D. Coastal deposition', 3);